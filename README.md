...
| **[code-review](skills/code-review/)** | Senior-engineer PR code review. Checks scope, conformance, correctness, efficiency, cyclomatic complexity, and dead code across a 12-phase workflow. | `review a PR`, `code review`, `review pull request`, attach a PR URL | `gh` CLI |
